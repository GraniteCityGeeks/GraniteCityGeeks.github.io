...
<div id="top" style="float:left">
    ...
    <div id="twitter">
        <a class="twitter-timeline" data-width="300" data-height="800" data-float="right" d href="https://twitter.com/PortlethenGC">Tweets by PortlethenGC</a> <script async src="//platform.twitter.com/widgets.js" charset="utf-8"></script>
    </div>
</div>
</body>
</html>