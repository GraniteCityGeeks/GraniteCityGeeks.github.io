...
while($row = $result->fetch_array()) {
    //echo all clubs
    echo "<form action='Clubs' method='get'>";
    echo"<img src='".$row['URL']. "height='300', width='300'>";
    echo"<h1><a href='Clubs' name='linkref' onclick=\"document.forms['name_of_your_form'].submit(); value='".$row['clubid']."'>".$row['clubTitle']."</a></h1>";
    echo"<br>";
    echo"</form>";
