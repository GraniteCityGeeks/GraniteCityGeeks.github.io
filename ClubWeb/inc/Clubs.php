...
$club = $params['linkref'];
echo $club;
$query = "SELECT clubTitle, clubcalendar, URL, Genre, C.description as clubDescription, G.description as Genre FROM port_club as C, port_genre as G, port_photo as P WHERE clubid = ".$club." AND G.genreid = C.genreid AND P.photoid = C.photoid";
